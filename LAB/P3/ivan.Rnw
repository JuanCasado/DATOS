\section{El segundo ejercicio de clasificación para datos cualitativos}
...
En esta parte realizamos el algoritmo Hunt con otros datos. Lo primero sera realizar el ejercicio normal
usando Gini como metodo para realizar la clasificación. La segunda parte la calcularemos usando la entropia. En
...
Ahora realizamos el programa usando la entropia. Para ello añadimos al  realizar el codigo de apart una parametro 
...
parametro que es minsize que indica el tamaño minimo permitido para un nodo.