...
for(i in 1:length(datos2$Resistencia)){if(datos2$Resistencia[i]<int[1]||datos2$Resistencia[i]>int[2]){print("el suceso de la resistencia de ");print(datos2$Resistencia[i]);print(" es un suceso outlier")}}
\end{center}
...
for(i in 1:length(datos2$Densidad)){if(datos2$Densidad[i]<int[1]||datos2$Densidad[i]>int[2]){print("el suceso de la densidad de ");print(datos2$Densidad[i]);print(" es un suceso outlier")}}
\end{center}
